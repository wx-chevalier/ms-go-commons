...
spec:
  ...
  - env:
    ...
    - name: START_STATS_SERVER
      value: "true"
    image: quay.io/wx-chevalier/discovery:0.13.33
...
spec:
  ...
  - env:
    ...
    - name: START_STATS_SERVER
      value: "true"
    image: quay.io/wx-chevalier/gloo:0.13.33
    imagePullPolicy: Always
    name: gloo
    ports:
    - containerPort: 9977
...
spec:
  ...
  - env:
    ...
    - name: START_STATS_SERVER
      value: "true"
    image: quay.io/wx-chevalier/gateway:0.13.33
    imagePullPolicy: Always
    name: gateway
    resources: {}
    securityContext:
...
spec:
  ...
  - args:
    ...
    image: quay.io/wx-chevalier/gloo-envoy-wrapper:0.13.33
    imagePullPolicy: Always
    name: gateway-proxy
    ports:
    - containerPort: 8080

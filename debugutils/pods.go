...
//go:generate mockgen -destination mocks_test.go -self_package github.com/wx-chevalier/go-utils/debugutils -package debugutils github.com/wx-chevalier/go-utils/debugutils PodFinder,LogCollector,ResourceCollector,StorageClient
